...
class ekf_commands():
    ...
    def diffEqInit(self, t, x, data: tp.ekf_data_t):
        ...
        self.Test = ct.quaternion2CTmatrix(data.q)

        # creating transformation matrix to body fixed using current quaternion
        self.T = ct.quaternion2CTmatrix(x[3:7])
    ...
    def diffEqTorques(self, data: tp.ekf_data_t):
        ...
        self.TT = self.TC + self.TG + self.TD
...
# checked til here
    def linearCoupling(self):
        ...
        self.LAD = np.matmul(self.Ii,self.LADtmp)
    ...
    def linearGravityGradient(self, data: tp.ekf_data_t):
        ...
        self.LGG = (6*(data.muE)/(self.rde*self.rde*self.rde)) * (rx_I_rx - Irx_rx)
...
# TODO: maybe remove argument type specifiers at top
    ...
    def ekf_linearization(self, data: tp.ekf_data_t):
        ...
        self.Tref2bf = ct.quaternion2CTmatrix(data.q)

        GMST = self.gstime(data.t0 + data.jdsatepoch)
    ...
    def ekf(self, data: tp.ekf_data_t):
        ...
        self.ekf_posterior_estimation(data)
